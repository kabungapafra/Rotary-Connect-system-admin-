        ...
        children: [
          ...
          const Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 2,
                  child: TableHeaderCell('When', align: TextAlign.right),
                ),
              ],
            ),
          ),
          if (events.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'No member issues recorded — all quiet.',
                  style: TextStyle(
                    fontSize: 12.5,
                    color: AdminColors.textMuted,
                  ),
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontStyle: event.memberName == null
                    ? FontStyle.italic
                    : FontStyle.normal,
                color: event.memberName == null
        ...
        children: [
          ...
          if (requests.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'No slow or failing requests recorded — the API has been fast.',
                  style: TextStyle(
                    fontSize: 12.5,
                    color: AdminColors.textMuted,
                  ),
