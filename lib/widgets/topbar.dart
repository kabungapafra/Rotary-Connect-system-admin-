...
const Map<String, List<String>> _pageMeta = {
  ...
  'members': ['Member Management', 'Search, filter, and manage members across clubs'],
        ...
        children: [
          Column(
            ...
            children: [
              Text(
                meta[0],
                style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, letterSpacing: -0.18),
              ),
              const SizedBox(height: 2),
              Text(meta[1], style: const TextStyle(fontSize: 12.5, color: AdminColors.textMuted)),
            ],
          ),
          if (state.view == 'clubs')
            Material(
